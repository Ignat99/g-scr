...
class DrakonRiemannSpacesConverterV7:
    ...
    def convert_to_riemann_spaces(self, py_source_path="rmsnorm.py"):
        """Трансляция алгоритмов с адаптивным распределением по листам геометрии"""
        ...
        for idx, node in enumerate(functions):
            ...
            self.cursor.execute("INSERT INTO diagrams VALUES (?, ?, ?, NULL, 120.0);", (diagram_id, func_name, origin_coords))
...
if __name__ == "__main__":
    converter = DrakonRiemannSpacesConverterV7("rmsnorm.drn")
    converter.convert_to_riemann_spaces("rmsnorm.py")
