...
#                self.cursor.execute("INSERT INTO tree_nodes VALUES (1, 0, 'item', NULL, ?);", (diagram_id,))
                ...
                self.cursor.execute("""
                    INSERT INTO items VALUES (?, ?, 'vertical', '', 0, 500, 420, 0, 340, 0, 0, NULL, NULL, NULL, NULL);
                """, (item_id, diagram_id,))
                item_id += 1
                ...
                if params_text:
                    ...
                    self.cursor.execute("""
                        INSERT INTO items VALUES (?, ?, 'horizontal', '', 0, 530, 420, 140, 0, 0, 0, NULL, NULL, NULL, NULL);
                    """, (item_id, diagram_id,))
                    item_id += 1
                    ...
                    self.cursor.execute("""
                        INSERT INTO items VALUES (?, ?, 'action', ?, 1, 690, 420, 50, 20, 0, 0, NULL, NULL, NULL, NULL);
                    """, (item_id, diagram_id, params_text,))
                    item_id += 1
